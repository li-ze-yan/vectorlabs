...
export const Introduce = () => {
	return (
		<section className="text-center px-8 h-screen flex justify-center items-center">
			<div>
				<motion.h2
				...
				<figure>
					<blockquote>
						...
						>
							从事前端开发工作三年多，主要使用{' '}
							<span className="text-sky-500 font-semibold dark:text-sky-400">React / Remix / Next / Vite</span>{' '}
							技术栈，对 <span className="text-sky-500 font-semibold dark:text-sky-400">React</span>{' '}
